...
田中: こんにちは。今回は日銀の金融政策について解説します。

鈴木: よろしくお願いします。結論から教えてください。

田中: 結論から言うと、日銀が政策金利を引き上げる可能性が高まっています。

鈴木: え、それって私たちの生活にも影響があるってことですか？

田中: その通りです。詳しく見ていきましょう。

## 本編

田中: まず第一の要因として、インフレ率の上昇が挙げられます。

鈴木: なるほど。具体的にどれくらい上昇しているんですか？

田中: 前年比で2.5パーセントの上昇となっています。

鈴木: それは結構大きな数字ですね。

田中: そうなんです。日銀の目標である2パーセントを超えています。

## クロージング

田中: 今回のポイントをまとめます。

鈴木: ありがとうございました。次回もよろしくお願いします。
"""
...
def sample_script_segments() -> List[Dict[str, str]]:
    """サンプル台本セグメント"""
    return [
        {"speaker": "田中", "text": "今日は重要なニュースについて解説します。"},
...
田中: こんにちは。今回は経済ニュースについて解説します。

鈴木: よろしくお願いします。

田中: 今日の重要なポイントは3つあります。
"""
